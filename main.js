...
console.log("Console out the numbers from 1-20. BACKWARDS.");
...
console.log(
  "For the string 'Boy howdy am I good at this!', console out the letters individually."
);
...
console.log(
  " For the string, 'And getting better every day.', starting with the second character, print out every third character."
);
...
console.log(
  "For the string 'Am I the best?', console out the letters individually, AND UPPERCASED."
);
